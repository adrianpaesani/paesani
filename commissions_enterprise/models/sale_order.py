...
class SaleOrder(models.Model):
    ...
    def _get_commission_calc(self):
        return self.env['ir.values'].sudo().get_default('sale.config.settings', 'commission_calc') or ''

    def _get_commission_pay(self):
        return self.env['ir.values'].sudo().get_default('sale.config.settings', 'commission_pay_on') or ''
    ...
    def _compute_commission_data(self):
        member_lst = []
        commission_pay_on = self.env['ir.values'].sudo().get_default('sale.config.settings', 'commission_pay_on')
